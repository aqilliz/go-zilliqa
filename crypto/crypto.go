...
import (
	...
	"github.com/aqilliz/go-zilliqa/common"
	"github.com/aqilliz/go-zilliqa/common/math"
	"github.com/aqilliz/go-zilliqa/crypto/sha3"
	"github.com/aqilliz/go-zilliqa/rlp"
)
...
// CreateAddress creates an zilliqa address given the bytes and the nonce
func CreateAddress(b common.Address, nonce uint64) common.Address {
	data, _ := rlp.EncodeToBytes([]interface{}{b, nonce})
	return common.BytesToAddress(Keccak256(data)[12:])
}

// CreateAddress2 creates an zilliqa address given the address bytes, initial
