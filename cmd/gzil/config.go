...
import (
	...
	"github.com/aqilliz/go-zilliqa/params"
...
type gzilConfig struct {
	Node node.Config
}

func loadConfig(file string, cfg *gzilConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func makeConfigNode(ctx *cli.Context) (*node.Node, gzilConfig) {
	// Load defaults.
	cfg := gzilConfig{
